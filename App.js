...
const saveSubsetWhiteListTask = createWhitelistFilter('task', ['task']);

const persistConfig = {
  key: 'root',
  storage: AsyncStorage,
  transforms: [SetTransform, saveSubsetWhiteListGlobal, saveSubsetWhiteListAuth, saveSubsetWhiteListTask],
  whitelist: ['global', 'auth', 'task'],
};
