...
class HomeMenuDrawer extends Component {
  ...
  render() {
    ...
    const userName = authSelectors.getUserDataUserName(authUser);

    const email = authSelectors.getUserDataEmail(authUser);
          ...
          <ScrollView contentContainerStyle={styles.contentContainer}>
            <View style={styles.userContainer}>
              ...
              <View style={styles.userDetailContainer}>
                <CustomText style={styles.userDetailTextStyle}>{userName}</CustomText>
                <CustomText style={styles.userDetailTextStyle}>{email}</CustomText>
              </View>
            </View>
